...
open class ChartUtils {
    ...
    internal class func drawMultilineText(context: CGContext, text: String, knownTextSize: CGSize, point: CGPoint, attributes: [NSAttributedString.Key: Any]?, constrainedToSize _: CGSize, anchor: CGPoint, angleRadians: CGFloat) {
